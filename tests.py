...
from main import wall, paddle, game_ball, draw_text, game_over, ball, player_paddle, is_game_over
...
def create_game_ball(create_player_paddle):
    return game_ball(create_player_paddle.x + (create_player_paddle.width // 2), create_player_paddle.y - create_player_paddle.height)


# Test case for the reset method of game_ball class
def test_game_ball_reset(create_player_paddle, create_game_ball):
    create_game_ball.reset(create_player_paddle.x + (create_player_paddle.width // 2), create_player_paddle.y - create_player_paddle.height)
    assert create_game_ball.rect.x == create_player_paddle.x + (create_player_paddle.width // 2) - create_game_ball.ball_rad
